...
set_aom_config_var(CONFIG_TUNE_RDMULT_DUMMY 0 "Dummy experiment on tuning RDMULT Parameter for use of other then SSIM metrics")
set_aom_config_var(CONFIG_TUNE_SSIM_DOUBLE 0 "Experiment where ssim variance scores are in double instead of int")
set_aom_config_var(CONFIG_WKX_MODE 0 "Experiment with adding temporal filtering like xpnsr metric")
set_aom_config_var(CONFIG_SALIENCY_MODE 0 "Experiment with saliency")
set_aom_config_var(CONFIG_AB_MODE 0 "Experiment with alpha-beta tunning")
set_aom_config_var(CONFIG_A_MODE 0 "Experiment with alpha tunning")
set_aom_config_var(CONFIG_WK_WKX_NORM_MODE 0 "To enable application of frame-level normmalization on WK or WKX maps")
set_aom_config_var(CONFIG_WK_WKX_INV_MODE 0 "To enable application of inverse on WK or WK maps (might need to be activated by default)")
set_aom_config_var(CONFIG_TUNE_RDM_SEP_AQ 0 "To enable tuning of RateDistortionMultiplier seperated from the QPk in AQP mode")
