...
typedef struct {
  ...
  // Indicates the folder where to dump the saliency map, scaling factors, ...
...
typedef struct AV1_COMP {
  ...
  double *saliency_factors;
#endif

#if CONFIG_TUNE_RDMULT_DUMMY
  double *wk_rdmult_scaling_factors;
  double *wkx_rdmult_scaling_factors;
  double *wk_high_pass_filtered;
  double wk_range;
  double wk_bin_width;
  double min_logwk;
  double max_logwk;
