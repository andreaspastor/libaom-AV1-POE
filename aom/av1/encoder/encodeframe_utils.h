...
void av1_set_rdmult_dummy(const AV1_COMP *const cpi,
                          int *errorperbit,
...
int av1_block_alpha_beta_aq(const AV1_COMP *const cpi, const BLOCK_SIZE bsize,
                       const int mi_row, const int mi_col);
int av1_block_alpha_aq(const AV1_COMP *const cpi, const BLOCK_SIZE bsize,
                            const int mi_row, const int mi_col);
#if CONFIG_SALIENCY_MODE
void av1_set_rdmult_saliency(const AV1_COMP *const cpi,
                             int *errorperbit,
                             const BLOCK_SIZE bsize,
                             const int mi_row, const int mi_col,
                             int *const rdmult);
int av1_block_saliency(const AV1_COMP *const cpi, const BLOCK_SIZE bsize,
                        const int mi_row, const int mi_col);
#endif
...
#if CONFIG_AB_MODE
void av1_set_rdmult_abmode(const AV1_COMP *const cpi,
                           int *errorperbit,
                           const BLOCK_SIZE bsize,
                           const int mi_row, const int mi_col,
                           int *const rdmult, double *const factor_a,
                           double *const factor_b, double *const spy_tracker);

int av1_block_abmode(const AV1_COMP *const cpi, const BLOCK_SIZE bsize,
                       const int mi_row, const int mi_col);
#endif
