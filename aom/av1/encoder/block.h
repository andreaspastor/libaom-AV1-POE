...
typedef struct macroblock {
   ...
   */
  int rdmult;
  double factor_a; //! factor_a used to calculate \ref rdmult
  double factor_b; //! factor_b used to calculate \ref rdmult
  double spy_tracker; //! spy_tracker to track if factor_a and factor_b are well initialized
