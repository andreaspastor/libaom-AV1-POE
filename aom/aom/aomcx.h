...
enum aome_enc_control_id {
  ...
  /*!\brief String to location where to dump information about scaling factors and saliency
   * const char * parameter.
   */
  AV1E_SET_DUMP_FOLDER = 155,
...
AOM_CTRL_USE_TYPE(AV1E_SET_DUMP_FOLDER, const char *)
#define AOM_CTRL_AV1E_SET_DUMP_FOLDER
